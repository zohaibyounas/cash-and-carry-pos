                ...
                {products.length === 0 ? (
                  ...
                  products.map((product: any) => (
                    ...
                    >
                      ...
                      >
                        {product.hasPieces ? (
                          `${Math.floor(product.totalStock / (product.piecesPerBox || 1))} ${product.unitName || 'Box'}${Math.floor(product.totalStock / (product.piecesPerBox || 1)) !== 1 ? 's' : ''}${product.totalStock % (product.piecesPerBox || 1) > 0 ? `, ${product.totalStock % (product.piecesPerBox || 1)} ${product.pieceName || 'Piece'}` : ''}`
                        ) : product.totalStock}
                      </td>
                      ...
                      <td className="px-4 py-3 text-right font-bold text-emerald-600 dark:text-emerald-400">
                        ...
                        {(
                          product.totalStock * (
                              product.hasPieces 
                                ? (Number(product.pieceCostPrice) || (Number(product.costPrice) / (Number(product.piecesPerBox) || 1))) 
