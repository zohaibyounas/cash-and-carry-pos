...
import { Bell, AlertTriangle, Package, Search } from "lucide-react";
import {
  Card,
  CardContent,
  CardHeader,
    ...
    <div className="min-h-screen space-y-8 bg-slate-50 p-6 dark:bg-slate-950 md:p-8">
      <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
        <div className="space-y-1">
          ...
          <p className="text-slate-500 dark:text-slate-400">
            Real-time inventory and stock status alerts.
          </p>
        </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription className="text-rose-600 dark:text-rose-400">
                  Action required: items nearing exhaustion
                </CardDescription>
              </div>
            </div>
