...
export default function ProductPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (
      !editingId &&
      formData.hasPieces &&
      formData.initialStockUnit === "box"
    ) {
      finalFormData.totalStock = (
        Number(formData.totalStock) * Number(formData.piecesPerBox)
      ).toString();
    }
          ...
          <CardContent>
            ...
            >
              ...
              <div className="space-y-2">
                <Label
                  htmlFor="barcode"
                  className="flex items-center text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400"
                >
              ...
              <div className="space-y-2">
                <Label
                  ...
                  className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400"
                >
                  {editingId ? "Update Stock" : "Initial Stock"}
                </Label>
                <div className="flex gap-2">
                  <Input
                    ...
                    onChange={handleInputChange}
                    className="flex-1 dark:bg-slate-800/50 dark:border-slate-700"
                    required
                  />
